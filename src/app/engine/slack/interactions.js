...
function interactions(request) {
  const params = personium.parseBodyAsQuery(request);
  console.log(JSON.stringify(params));

  return {
    status: 200,
    headers: {},
    body: ['interaction received'],
  };
}
      ...
      elements: [
        {
          ...
          url:
            'https://app-personium-lifelog.ohesonium.mydns.jp/__/slack/start_oauth',
          style: 'primary',
        },
      ],
    });
